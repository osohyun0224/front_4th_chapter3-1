  ...
  export const mockCreateEvent = (events: Event[] = [], eventData: EventForm): { list: Event[], createdEvent: Event } => {
  ...
  export const mockUpdateEvent = (events: Event[] = [], eventData: Event): { status: number, updatedEvent?: Event, list: Event[], message?: string } => {
  ...
  export const mockDeleteEvent = (events: Event[] = [], eventId: string): { status: number, message?: string, list: Event[] } => {
